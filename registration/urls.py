...
from .views import (
    ...
    enrollment_tracker,
    enrollment_course_roster,
    enrollment_batch_roster,
...
urlpatterns = [
    ...
    path('enrollment-tracker/', enrollment_tracker, name='enrollment_tracker'),
    path('enrollment/course-roster/', enrollment_course_roster, name='enrollment_course_roster'),
    path('enrollment/batch-roster/', enrollment_batch_roster, name='enrollment_batch_roster'),
    ...
    path('enrollments/export/zoho/installments/', export_zoho_installments_view, name='export_zoho_installments'),
